@echo off
REM ================================================================
REM  Daily KR Stock Price Update
REM  Fetches latest close price, PER, PBR for all KR stocks
REM  Schedule via Task Scheduler: weekdays 18:00 KST
REM ================================================================

set PROJECT_DIR=C:\Users\laser\OneDrive\2026\vibecode\korean_stock
set PYTHON=C:\Python314\python.exe
set LOG_DIR=%PROJECT_DIR%\logs
set LOG_FILE=%LOG_DIR%\daily_update_%date:~0,4%%date:~5,2%%date:~8,2%.log

REM Create log directory if needed
if not exist "%LOG_DIR%" mkdir "%LOG_DIR%"

echo [%date% %time%] Starting daily KR stock price update >> "%LOG_FILE%"
