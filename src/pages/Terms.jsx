                    ...
                    <div style={{
                        ...
                        <section style={{ marginBottom: '40px' }}>
                            ...
                            <div style={{
                                ...
                                <ul style={{ color: '#c0c0d0', paddingLeft: '20px', margin: 0 }}>
                                    <li style={{ marginBottom: '10px' }}>
                                        <strong style={{ color: '#ff4d4f' }}>데이터 정확성 면책:</strong> 본 사이트는 금융감독원 DART의 공시 자료를 자동으로 처리하여 제공하며,
                                        데이터 수집·가공·표시 과정에서 발생할 수 있는 오류, 누락, 지연에 대해 <strong style={{ color: '#ff4d4f' }}>어떠한 법적 책임도 지지 않습니다.</strong>
                                    </li>
                                    <li style={{ marginBottom: '10px' }}>
                                        <strong style={{ color: '#ff4d4f' }}>손해배상 면책:</strong> 본 서비스의 데이터 오류로 인해 발생한 직접적·간접적·부수적·파생적 손해
                                        (투자 손실, 기회 손실 등 일체 포함)에 대해 운영자는 <strong style={{ color: '#ff4d4f' }}>법적 책임을 지지 않습니다.</strong>
                                    </li>
                                    <li style={{ marginBottom: '10px' }}>
                                        <strong style={{ color: '#ff4d4f' }}>투자 판단 책임:</strong> 본 서비스는 투자 조언이 아니며,
                                        모든 투자 결정 및 그 결과(손익)에 대한 법적 책임은 <strong style={{ color: '#ff4d4f' }}>전적으로 이용자 본인</strong>에게 있습니다.
                                    </li>
                                    <li>
                                        <strong style={{ color: '#ff4d4f' }}>검증 의무:</strong> 실제 투자 전 반드시 공식 증권사, 금융감독원, 한국거래소 등의
