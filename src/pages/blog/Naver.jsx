                ...
                <div style={{ maxWidth: '900px', margin: '0 auto', width: '100%' }}>
                    ...
                    <header style={{ marginBottom: '40px', paddingBottom: '20px', borderBottom: '2px solid #2a2a30' }}>
                        <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '15px', flexWrap: 'wrap' }}>
                            ...
                            <span style={{ background: '#064e3b', padding: '6px 14px', borderRadius: '20px', fontSize: '0.8rem', color: '#00d084' }}>AI 선도기업</span>
                        </div>
                        <h1 style={{
                            fontSize: isMobile ? '1.8rem' : '2.5rem',
                            fontWeight: '900',
                            background: 'linear-gradient(135deg, #22c55e 0%, #00d084 100%)',
                    ...
                    <article style={{
                        ...
                        <section style={{ marginBottom: '45px' }}>
                            ...
                            <div style={{ background: '#141417', borderRadius: '12px', padding: '20px', marginBottom: '25px', border: '1px solid #2a2a30' }}>
                                ...
                                <ul style={{ color: '#8888a0', margin: 0, paddingLeft: '20px' }}>
                                    <li style={{ marginBottom: '10px' }}><strong style={{ color: '#f0f0f5' }}>서치플랫폼:</strong> 검색광고, 디스플레이 광고 (네이버 검색, 뉴스, 블로그)</li>
                                    <li style={{ marginBottom: '10px' }}><strong style={{ color: '#f0f0f5' }}>커머스:</strong> 스마트스토어, 네이버쇼핑, 브랜드스토어</li>
                                    <li style={{ marginBottom: '10px' }}><strong style={{ color: '#f0f0f5' }}>핀테크:</strong> 네이버페이, 네이버파이낸셜</li>
                                    <li style={{ marginBottom: '10px' }}><strong style={{ color: '#f0f0f5' }}>콘텐츠:</strong> 네이버웹툰, V LIVE, 스노우</li>
                                    <li><strong style={{ color: '#f0f0f5' }}>클라우드:</strong> 네이버클라우드, AI (하이퍼클로바X)</li>
                                </ul>
                            </div>

                            <div style={{ background: 'linear-gradient(135deg, #064e3b 0%, #141417 100%)', borderRadius: '12px', padding: '25px', marginBottom: '25px', border: '1px solid #22c55e' }}>
                        ...
                        <section style={{ marginBottom: '45px' }}>
                            ...
                            <div style={{
                                ...
                                <div style={{ display: 'grid', gridTemplateColumns: isMobile ? '1fr' : 'repeat(3, 1fr)', gap: '20px' }}>
                                    <div style={{ textAlign: 'center' }}>
                                        ...
                                        <p style={{ color: '#f0f0f5', fontSize: '1.5rem', fontWeight: '700', margin: 0 }}>3조 1,381억</p>
                                    </div>
                                    <div style={{ textAlign: 'center' }}>
                                        <p style={{ color: '#8888a0', fontSize: '0.9rem', marginBottom: '5px' }}>영업이익</p>
                                        <p style={{ color: '#00d084', fontSize: '1.5rem', fontWeight: '700', margin: 0 }}>5,706억</p>
                                    </div>
                                    <div style={{ textAlign: 'center' }}>
                                        <p style={{ color: '#8888a0', fontSize: '0.9rem', marginBottom: '5px' }}>영업이익률</p>
                                        <p style={{ color: '#cc6e00', fontSize: '1.5rem', fontWeight: '700', margin: 0 }}>약 18.2%</p>
                                    </div>
                                </div>
                            </div>
                                ...
                                <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '0.9rem' }}>
                                    ...
                                    <tbody>
                                        <tr style={{ borderBottom: '1px solid #2a2a30' }}>
                                            ...
                                            <td style={{ color: '#f0f0f5', padding: '10px', textAlign: 'right' }}>2.89조</td>
                                            <td style={{ color: '#00d084', padding: '10px', textAlign: 'right' }}>5,420억</td>
                                            <td style={{ color: '#cc6e00', padding: '10px', textAlign: 'right' }}>18.8%</td>
                                        </tr>
                                        <tr style={{ borderBottom: '1px solid #2a2a30' }}>
                                            <td style={{ color: '#f0f0f5', padding: '10px' }}>2025 1Q</td>
                                            <td style={{ color: '#f0f0f5', padding: '10px', textAlign: 'right' }}>2.79조</td>
                                            <td style={{ color: '#00d084', padding: '10px', textAlign: 'right' }}>5,053억</td>
                                            <td style={{ color: '#cc6e00', padding: '10px', textAlign: 'right' }}>18.1%</td>
                                        </tr>
                                        <tr style={{ borderBottom: '1px solid #2a2a30' }}>
                                            <td style={{ color: '#f0f0f5', padding: '10px' }}>2025 2Q</td>
                                            <td style={{ color: '#f0f0f5', padding: '10px', textAlign: 'right' }}>2.92조</td>
                                            <td style={{ color: '#00d084', padding: '10px', textAlign: 'right' }}>5,216억</td>
                                            <td style={{ color: '#cc6e00', padding: '10px', textAlign: 'right' }}>17.9%</td>
                                        </tr>
                                        <tr>
                                            <td style={{ color: '#f0f0f5', padding: '10px', fontWeight: '600' }}>2025 3Q</td>
                                            <td style={{ color: '#f0f0f5', padding: '10px', textAlign: 'right', fontWeight: '600' }}>3.14조</td>
                                            <td style={{ color: '#00d084', padding: '10px', textAlign: 'right', fontWeight: '600' }}>5,706억</td>
                                            <td style={{ color: '#cc6e00', padding: '10px', textAlign: 'right', fontWeight: '600' }}>18.2%</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                            ...
                            <div style={{ background: '#141417', borderRadius: '12px', padding: '20px', marginBottom: '25px', border: '1px solid #2a2a30' }}>
                                <h4 style={{ color: '#d4a853', marginBottom: '12px', fontSize: '1rem' }}>💡 플랫폼 기업의 수익 구조</h4>
                        ...
                        <section style={{ marginBottom: '45px' }}>
                            ...
                            <div style={{ background: '#141417', borderRadius: '12px', padding: '25px', marginBottom: '25px', border: '1px solid #d4a853' }}>
                                ...
                                <div style={{ marginBottom: '20px' }}>
                                    <h4 style={{ color: '#f0f0f5', fontSize: '1rem', marginBottom: '8px' }}>1. AI 검색 경쟁</h4>
                                    <p style={{ color: '#8888a0', margin: 0, fontSize: '0.95rem' }}>구글, OpenAI 등 글로벌 빅테크와의 AI 검색 경쟁이 심화되고 있습니다.</p>
                                </div>
                                <div style={{ marginBottom: '20px' }}>
                                    <h4 style={{ color: '#f0f0f5', fontSize: '1rem', marginBottom: '8px' }}>2. 라인야후 이슈</h4>
                                    <p style={{ color: '#8888a0', margin: 0, fontSize: '0.95rem' }}>일본 정부의 압박으로 라인야후 지분 매각 가능성이 있으며, 이는 기업 가치에 영향을 미칠 수 있습니다.</p>
                                </div>
                                <div style={{ marginBottom: '20px' }}>
                                    <h4 style={{ color: '#f0f0f5', fontSize: '1rem', marginBottom: '8px' }}>3. 광고 시장 경기 민감도</h4>
                                    <p style={{ color: '#8888a0', margin: 0, fontSize: '0.95rem' }}>검색광고 매출은 경기 변동에 민감하며, 경기 침체 시 광고주 지출이 감소할 수 있습니다.</p>
                                </div>
                                <div>
                                    <h4 style={{ color: '#f0f0f5', fontSize: '1rem', marginBottom: '8px' }}>4. 커머스 경쟁 심화</h4>
                                    <p style={{ color: '#8888a0', margin: 0, fontSize: '0.95rem' }}>쿠팡, 11번가 등과의 이커머스 경쟁이 심화되고 있습니다.</p>
                                </div>
                            </div>
                        ...
                        {/* CTA Section */}
                        <section style={{
                            background: 'linear-gradient(135deg, #064e3b 0%, #FF8C00 100%)',
                    ...
                    <div style={{ marginTop: '40px', padding: '30px', background: 'rgba(0, 0, 0, 0.6)', borderRadius: '16px', border: '1px solid rgba(255, 255, 255, 0.06)' }}>
                        ...
                        <div style={{ display: 'flex', flexWrap: 'wrap', gap: '12px' }}>
                            <Link to="/stocks/035720" style={{ color: '#FF8C00', background: 'rgba(255, 140, 0, 0.08)', padding: '10px 18px', borderRadius: '8px', textDecoration: 'none', fontSize: '0.9rem' }}>카카오 (035720)</Link>
                            <Link to="/stocks/259960" style={{ color: '#FF8C00', background: 'rgba(255, 140, 0, 0.08)', padding: '10px 18px', borderRadius: '8px', textDecoration: 'none', fontSize: '0.9rem' }}>크래프톤 (259960)</Link>
                            <Link to="/stocks/036570" style={{ color: '#FF8C00', background: 'rgba(255, 140, 0, 0.08)', padding: '10px 18px', borderRadius: '8px', textDecoration: 'none', fontSize: '0.9rem' }}>엔씨소프트 (036570)</Link>
                        </div>
                    </div>
