                ...
                <div style={{ maxWidth: '900px', margin: '0 auto', width: '100%' }}>
                    ...
                    <header style={{ marginBottom: '40px', paddingBottom: '20px', borderBottom: '2px solid #2a2a30' }}>
                        <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '15px', flexWrap: 'wrap' }}>
                            ...
                            <span style={{ background: 'rgba(255, 140, 0, 0.08)', padding: '6px 14px', borderRadius: '20px', fontSize: '0.8rem', color: '#FF8C00' }}>2차전지 제조업</span>
                            <span style={{ background: '#064e3b', padding: '6px 14px', borderRadius: '20px', fontSize: '0.8rem', color: '#00d084' }}>글로벌 TOP 2</span>
                        </div>
                        <h1 style={{
                    ...
                    <article style={{
                        ...
                        <section style={{ marginBottom: '45px' }}>
                            ...
                            <div style={{ background: '#141417', borderRadius: '12px', padding: '20px', marginBottom: '25px', border: '1px solid #2a2a30' }}>
                                ...
                                <ul style={{ color: '#8888a0', margin: 0, paddingLeft: '20px' }}>
                                    <li style={{ marginBottom: '10px' }}><strong style={{ color: '#f0f0f5' }}>EV 배터리:</strong> 전기차용 파우치/원통형 배터리 (테슬라, GM, 현대 등 공급)</li>
                                    <li style={{ marginBottom: '10px' }}><strong style={{ color: '#f0f0f5' }}>ESS:</strong> 에너지저장시스템용 대용량 배터리 (전력 그리드, 가정용)</li>
                                    <li><strong style={{ color: '#f0f0f5' }}>소형전지:</strong> IT기기, 전동공구용 배터리</li>
                                </ul>
                            </div>
                            ...
                            <div style={{ background: 'linear-gradient(135deg, #064e3b 0%, #141417 100%)', borderRadius: '12px', padding: '25px', marginBottom: '25px', border: '1px solid #22c55e' }}>
                                ...
                                <ul style={{ color: '#8888a0', margin: 0, paddingLeft: '20px' }}>
                                    <li style={{ marginBottom: '8px' }}><strong style={{ color: '#f0f0f5' }}>한국:</strong> 오창, 대전</li>
                                    <li style={{ marginBottom: '8px' }}><strong style={{ color: '#f0f0f5' }}>미국:</strong> 미시간(GM JV), 오하이오(Honda JV), 애리조나</li>
                                    <li style={{ marginBottom: '8px' }}><strong style={{ color: '#f0f0f5' }}>유럽:</strong> 폴란드</li>
                                    <li><strong style={{ color: '#f0f0f5' }}>중국:</strong> 난징</li>
                                </ul>
                            </div>
                        </section>
                        ...
                        <section style={{ marginBottom: '45px' }}>
                            ...
                            <div style={{
                                ...
                                <div style={{ display: 'grid', gridTemplateColumns: isMobile ? '1fr' : 'repeat(3, 1fr)', gap: '20px' }}>
                                    <div style={{ textAlign: 'center' }}>
                                        ...
                                        <p style={{ color: '#f0f0f5', fontSize: '1.5rem', fontWeight: '700', margin: 0 }}>5조 6,999억</p>
                                    </div>
                                    <div style={{ textAlign: 'center' }}>
                                        <p style={{ color: '#8888a0', fontSize: '0.9rem', marginBottom: '5px' }}>영업이익</p>
                                        <p style={{ color: '#00d084', fontSize: '1.5rem', fontWeight: '700', margin: 0 }}>6,013억</p>
                                    </div>
                                    <div style={{ textAlign: 'center' }}>
                                        <p style={{ color: '#8888a0', fontSize: '0.9rem', marginBottom: '5px' }}>영업이익률</p>
                                        <p style={{ color: '#cc6e00', fontSize: '1.5rem', fontWeight: '700', margin: 0 }}>약 10.5%</p>
                                    </div>
                                </div>
                            </div>

                            <h3 style={{ color: '#f0f0f5', fontSize: '1.2rem', marginBottom: '15px' }}>실적 턴어라운드</h3>
                            <p style={{ color: '#c0c0d0', marginBottom: '20px' }}>
                                2024년 4분기 <strong style={{ color: '#ff4d4f' }}>-2,255억원</strong>의 영업적자를 기록했던
                                LG에너지솔루션은 2026년 들어 흑자 전환에 성공했습니다. 3분기에는 영업이익
                                <strong style={{ color: '#00d084' }}> 6,013억원</strong>을 기록하며 영업이익률이
                                <strong style={{ color: '#cc6e00' }}> 10%대</strong>를 회복했습니다.
                            </p>
                                ...
                                <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '0.9rem' }}>
                                    ...
                                    <tbody>
                                        <tr style={{ borderBottom: '1px solid #2a2a30' }}>
                                            ...
                                            <td style={{ color: '#f0f0f5', padding: '10px', textAlign: 'right' }}>6.5조</td>
                                            <td style={{ color: '#ff4d4f', padding: '10px', textAlign: 'right' }}>-2,255억</td>
                                        </tr>
                                        <tr style={{ borderBottom: '1px solid #2a2a30' }}>
                                            <td style={{ color: '#f0f0f5', padding: '10px' }}>2025 1Q</td>
                                            <td style={{ color: '#f0f0f5', padding: '10px', textAlign: 'right' }}>6.3조</td>
                                            <td style={{ color: '#00d084', padding: '10px', textAlign: 'right' }}>3,747억</td>
                                        </tr>
                                        <tr style={{ borderBottom: '1px solid #2a2a30' }}>
                                            <td style={{ color: '#f0f0f5', padding: '10px' }}>2025 2Q</td>
                                            <td style={{ color: '#f0f0f5', padding: '10px', textAlign: 'right' }}>5.6조</td>
                                            <td style={{ color: '#00d084', padding: '10px', textAlign: 'right' }}>4,922억</td>
                                        </tr>
                                        <tr>
                                            <td style={{ color: '#f0f0f5', padding: '10px', fontWeight: '600' }}>2025 3Q</td>
                                            <td style={{ color: '#f0f0f5', padding: '10px', textAlign: 'right', fontWeight: '600' }}>5.7조</td>
                                            <td style={{ color: '#00d084', padding: '10px', textAlign: 'right', fontWeight: '600' }}>6,013억</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                            ...
                            <div style={{ background: '#141417', borderRadius: '12px', padding: '20px', marginBottom: '25px', border: '1px solid #2a2a30' }}>
                                <h4 style={{ color: '#d4a853', marginBottom: '12px', fontSize: '1rem' }}>💡 IRA 효과 이해하기</h4>
                        ...
                        <section style={{ marginBottom: '45px' }}>
                            ...
                            <div style={{ background: '#141417', borderRadius: '12px', padding: '25px', marginBottom: '25px', border: '1px solid #d4a853' }}>
                                ...
                                <div style={{ marginBottom: '20px' }}>
                                    <h4 style={{ color: '#f0f0f5', fontSize: '1rem', marginBottom: '8px' }}>1. 전기차 수요 둔화</h4>
                                    <p style={{ color: '#8888a0', margin: 0, fontSize: '0.95rem' }}>
                                ...
                                <div style={{ marginBottom: '20px' }}>
                                    <h4 style={{ color: '#f0f0f5', fontSize: '1rem', marginBottom: '8px' }}>2. 중국 업체와의 경쟁</h4>
                                    <p style={{ color: '#8888a0', margin: 0, fontSize: '0.95rem' }}>
                                ...
                                <div>
                                    <h4 style={{ color: '#f0f0f5', fontSize: '1rem', marginBottom: '8px' }}>4. IRA 정책 변동 리스크</h4>
                                    <p style={{ color: '#8888a0', margin: 0, fontSize: '0.95rem' }}>
                    ...
                    <div style={{ marginTop: '40px', padding: '30px', background: 'rgba(0, 0, 0, 0.6)', borderRadius: '16px', border: '1px solid rgba(255, 255, 255, 0.06)' }}>
                        ...
                        <div style={{ display: 'flex', flexWrap: 'wrap', gap: '12px' }}>
                            <Link to="/stocks/006400" style={{ color: '#FF8C00', background: 'rgba(255, 140, 0, 0.08)', padding: '10px 18px', borderRadius: '8px', textDecoration: 'none', fontSize: '0.9rem' }}>삼성SDI (006400)</Link>
                            <Link to="/stocks/051910" style={{ color: '#FF8C00', background: 'rgba(255, 140, 0, 0.08)', padding: '10px 18px', borderRadius: '8px', textDecoration: 'none', fontSize: '0.9rem' }}>LG화학 (051910)</Link>
