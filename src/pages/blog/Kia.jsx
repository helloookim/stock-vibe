...
const Kia = () => {
    ...
    return (
        <>
            <SEOHead
                title={t('blogSeo.kia.title')}
                description={t('blogSeo.kia.description')}
                keywords={t('blogSeo.kia.keywords')}
                canonical="https://kstockview.com/blog/kia"
                ogType="article"
                jsonLd={[
                    {
                        '@type': 'Article',
                        headline: t('blogSeo.kia.ogTitle'),
                        ...
                        mainEntityOfPage: { '@type': 'WebPage', '@id': 'https://kstockview.com/blog/kia' }
                    },
                    {
                        '@type': 'BreadcrumbList',
                        itemListElement: [
                            ...
                            { '@type': 'ListItem', position: 3, name: 'Kia' }
                        ]
                    },
                    {
                        '@type': 'FAQPage',
                        mainEntity: [
                            { '@type': 'Question', name: t('faq.kia.q1'), acceptedAnswer: { '@type': 'Answer', text: t('faq.kia.a1') } },
                            { '@type': 'Question', name: t('faq.kia.q2'), acceptedAnswer: { '@type': 'Answer', text: t('faq.kia.a2') } }
                        ]
                    }
                ]}
            />
                ...
                <div style={{ maxWidth: '900px', margin: '0 auto', width: '100%' }}>
                    ...
                    <header style={{ marginBottom: '40px', paddingBottom: '20px', borderBottom: '2px solid #2a2a30' }}>
                        <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '15px', flexWrap: 'wrap' }}>
                            <span style={{ background: 'linear-gradient(135deg, #dc2626 0%, #ff4d4f 100%)', padding: '6px 14px', borderRadius: '20px', fontSize: '0.8rem', fontWeight: '600' }}>기업분석</span>
                            <span style={{ background: 'rgba(255, 140, 0, 0.08)', padding: '6px 14px', borderRadius: '20px', fontSize: '0.8rem', color: '#FF8C00' }}>자동차 제조업</span>
                            <span style={{ background: '#064e3b', padding: '6px 14px', borderRadius: '20px', fontSize: '0.8rem', color: '#00d084' }}>현대차그룹</span>
                        </div>
                        <h1 style={{
                            fontSize: isMobile ? '1.8rem' : '2.5rem',
                            fontWeight: '900',
                            background: 'linear-gradient(135deg, #ff4d4f 0%, #f97316 100%)',
                    ...
                    <article style={{
                        ...
                        <section style={{ marginBottom: '45px' }}>
                            <p style={{ color: '#c0c0d0', marginBottom: '20px' }}>
                                <strong style={{ color: '#ff4d4f' }}>기아</strong>는 현대자동차그룹의 핵심 계열사로,
                        ...
                        <section style={{ marginBottom: '45px' }}>
                            <h2 style={{ color: '#f0f0f5', fontSize: isMobile ? '1.3rem' : '1.6rem', marginBottom: '25px', display: 'flex', alignItems: 'center', gap: '12px' }}>
                                <Car size={24} style={{ color: '#ff4d4f' }} />
                                1. 기업 개요 및 브랜드 혁신
                            </h2>
                            ...
                            <p style={{ color: '#c0c0d0', marginBottom: '20px' }}>
                                ...
                                <strong style={{ color: '#ff4d4f' }}> 모빌리티 기업으로의 전환</strong>을 선언했습니다.
                            ...
                            <div style={{ background: '#141417', borderRadius: '12px', padding: '20px', marginBottom: '25px', border: '1px solid #2a2a30' }}>
                                <h3 style={{ color: '#ff4d4f', marginBottom: '15px', fontSize: '1.1rem' }}>주요 차종 라인업</h3>
                                <ul style={{ color: '#8888a0', margin: 0, paddingLeft: '20px' }}>
                                    <li style={{ marginBottom: '10px' }}><strong style={{ color: '#f0f0f5' }}>SUV:</strong> 텔루라이드, 쏘렌토, 스포티지, 니로, 셀토스</li>
                                    <li style={{ marginBottom: '10px' }}><strong style={{ color: '#f0f0f5' }}>세단:</strong> K8, K5, K3, 스팅어</li>
                                    <li style={{ marginBottom: '10px' }}><strong style={{ color: '#f0f0f5' }}>전기차:</strong> EV6, EV9, EV3, 니로 EV</li>
                                    <li><strong style={{ color: '#f0f0f5' }}>상용/MPV:</strong> 카니발, 봉고</li>
                                </ul>
                            </div>

                            <div style={{ background: 'linear-gradient(135deg, #7f1d1d 0%, #141417 100%)', borderRadius: '12px', padding: '25px', marginBottom: '25px', border: '1px solid #ff4d4f' }}>
                                <h3 style={{ color: '#ff4d4f', marginBottom: '15px', fontSize: '1.1rem' }}>기아 브랜드 혁신의 성과</h3>
                        ...
                        <section style={{ marginBottom: '45px' }}>
                            ...
                            <div style={{
                                ...
                                <h3 style={{ color: '#ff4d4f', marginBottom: '20px', fontSize: '1.2rem', textAlign: 'center' }}>
                                    2026년 3분기 주요 실적 (연결 기준)
                                </h3>
                                <div style={{ display: 'grid', gridTemplateColumns: isMobile ? '1fr' : 'repeat(3, 1fr)', gap: '20px' }}>
                                    <div style={{ textAlign: 'center' }}>
                                        <p style={{ color: '#8888a0', fontSize: '0.9rem', marginBottom: '5px' }}>매출액</p>
                                        <p style={{ color: '#f0f0f5', fontSize: '1.5rem', fontWeight: '700', margin: 0 }}>28조 6,860억</p>
                                    </div>
                                    <div style={{ textAlign: 'center' }}>
                                        <p style={{ color: '#8888a0', fontSize: '0.9rem', marginBottom: '5px' }}>영업이익</p>
                                        <p style={{ color: '#00d084', fontSize: '1.5rem', fontWeight: '700', margin: 0 }}>1조 4,623억</p>
                                    </div>
                                    <div style={{ textAlign: 'center' }}>
                                        <p style={{ color: '#8888a0', fontSize: '0.9rem', marginBottom: '5px' }}>영업이익률</p>
                                        <p style={{ color: '#cc6e00', fontSize: '1.5rem', fontWeight: '700', margin: 0 }}>약 5.1%</p>
                                    </div>
                                </div>
                            </div>

                            <h3 style={{ color: '#f0f0f5', fontSize: '1.2rem', marginBottom: '15px' }}>분기별 실적 추이</h3>
                            <div style={{ background: '#141417', borderRadius: '12px', padding: '20px', marginBottom: '25px', border: '1px solid #2a2a30' }}>
                                <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '0.9rem' }}>
                                    ...
                                    <tbody>
                                        <tr style={{ borderBottom: '1px solid #2a2a30' }}>
                                            ...
                                            <td style={{ color: '#f0f0f5', padding: '10px', textAlign: 'right' }}>27.1조</td>
                                            <td style={{ color: '#00d084', padding: '10px', textAlign: 'right' }}>2.7조</td>
                                            <td style={{ color: '#cc6e00', padding: '10px', textAlign: 'right' }}>10.0%</td>
                                        </tr>
                                        <tr style={{ borderBottom: '1px solid #2a2a30' }}>
                                            <td style={{ color: '#f0f0f5', padding: '10px' }}>2025 1Q</td>
                                            <td style={{ color: '#f0f0f5', padding: '10px', textAlign: 'right' }}>28.0조</td>
                                            <td style={{ color: '#00d084', padding: '10px', textAlign: 'right' }}>3.0조</td>
                                            <td style={{ color: '#cc6e00', padding: '10px', textAlign: 'right' }}>10.7%</td>
                                        </tr>
                                        <tr style={{ borderBottom: '1px solid #2a2a30' }}>
                                            <td style={{ color: '#f0f0f5', padding: '10px' }}>2025 2Q</td>
                                            <td style={{ color: '#f0f0f5', padding: '10px', textAlign: 'right' }}>29.3조</td>
                                            <td style={{ color: '#00d084', padding: '10px', textAlign: 'right' }}>2.8조</td>
                                            <td style={{ color: '#cc6e00', padding: '10px', textAlign: 'right' }}>9.4%</td>
                                        </tr>
                                        <tr>
                                            <td style={{ color: '#f0f0f5', padding: '10px', fontWeight: '600' }}>2025 3Q</td>
                                            <td style={{ color: '#f0f0f5', padding: '10px', textAlign: 'right', fontWeight: '600' }}>28.7조</td>
                                            <td style={{ color: '#00d084', padding: '10px', textAlign: 'right', fontWeight: '600' }}>1.5조</td>
                                            <td style={{ color: '#cc6e00', padding: '10px', textAlign: 'right', fontWeight: '600' }}>5.1%</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                            ...
                            <div style={{ background: '#141417', borderRadius: '12px', padding: '20px', marginBottom: '25px', border: '1px solid #2a2a30' }}>
                                <h4 style={{ color: '#d4a853', marginBottom: '12px', fontSize: '1rem' }}>💡 기아 vs 현대차 수익성 비교</h4>
                        ...
                        <section style={{ marginBottom: '45px' }}>
                            ...
                            <div style={{ background: '#141417', borderRadius: '12px', padding: '25px', marginBottom: '25px', border: '1px solid #d4a853' }}>
                                ...
                                <div style={{ marginBottom: '20px' }}>
                                    ...
                                    <p style={{ color: '#8888a0', margin: 0, fontSize: '0.95rem' }}>테슬라, BYD 등과의 전기차 경쟁이 심화되고 있으며, 가격 경쟁 압박이 증가하고 있습니다.</p>
                                </div>
                                <div style={{ marginBottom: '20px' }}>
                                    <h4 style={{ color: '#f0f0f5', fontSize: '1rem', marginBottom: '8px' }}>2. 환율 변동</h4>
                                    <p style={{ color: '#8888a0', margin: 0, fontSize: '0.95rem' }}>수출 비중이 높아 원/달러 환율 변동에 실적이 영향받습니다.</p>
                                </div>
                                <div style={{ marginBottom: '20px' }}>
                                    <h4 style={{ color: '#f0f0f5', fontSize: '1rem', marginBottom: '8px' }}>3. 현대차그룹 의존도</h4>
                                    <p style={{ color: '#8888a0', margin: 0, fontSize: '0.95rem' }}>플랫폼, 기술, 부품을 현대차와 공유하여 그룹 리스크에 함께 노출됩니다.</p>
                                </div>
                                <div>
                                    <h4 style={{ color: '#f0f0f5', fontSize: '1rem', marginBottom: '8px' }}>4. 노사 리스크</h4>
                                    <p style={{ color: '#8888a0', margin: 0, fontSize: '0.95rem' }}>강성 노조로 인한 파업 가능성과 인건비 상승 압력이 있습니다.</p>
                                </div>
                            </div>
                        ...
                        <section style={{
                            ...
                            textAlign: 'center', border: '1px solid #ff4d4f'
                        }}>
                    ...
                    <div style={{ marginTop: '40px', padding: '30px', background: 'rgba(0, 0, 0, 0.6)', borderRadius: '16px', border: '1px solid rgba(255, 255, 255, 0.06)' }}>
                        ...
                        <div style={{ display: 'flex', flexWrap: 'wrap', gap: '12px' }}>
                            <Link to="/stocks/005380" style={{ color: '#FF8C00', background: 'rgba(255, 140, 0, 0.08)', padding: '10px 18px', borderRadius: '8px', textDecoration: 'none', fontSize: '0.9rem' }}>현대자동차 (005380)</Link>
