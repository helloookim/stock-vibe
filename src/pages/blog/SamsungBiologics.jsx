                ...
                <div style={{ maxWidth: '900px', margin: '0 auto', width: '100%' }}>
                    ...
                    <header style={{ marginBottom: '40px', paddingBottom: '20px', borderBottom: '2px solid #2a2a30' }}>
                        <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '15px', flexWrap: 'wrap' }}>
                            <span style={{ background: 'linear-gradient(135deg, #7c3aed 0%, #FFa040 100%)', padding: '6px 14px', borderRadius: '20px', fontSize: '0.8rem', fontWeight: '600' }}>기업분석</span>
                            <span style={{ background: 'rgba(255, 140, 0, 0.08)', padding: '6px 14px', borderRadius: '20px', fontSize: '0.8rem', color: '#FF8C00' }}>바이오 제조업</span>
                            <span style={{ background: '#4c1d95', padding: '6px 14px', borderRadius: '20px', fontSize: '0.8rem', color: '#FFa040' }}>CMO 세계 1위</span>
                        </div>
                        <h1 style={{
                            fontSize: isMobile ? '1.8rem' : '2.5rem',
                            fontWeight: '900',
                            background: 'linear-gradient(135deg, #FFa040 0%, #ec4899 100%)',
                    ...
                    <article style={{
                        ...
                        <section style={{ marginBottom: '45px' }}>
                            <p style={{ color: '#c0c0d0', marginBottom: '20px' }}>
                                <strong style={{ color: '#FFa040' }}>삼성바이오로직스</strong>는 바이오의약품 위탁생산(CMO) 시장에서
                        ...
                        <section style={{ marginBottom: '45px' }}>
                            <h2 style={{ color: '#f0f0f5', fontSize: isMobile ? '1.3rem' : '1.6rem', marginBottom: '25px', display: 'flex', alignItems: 'center', gap: '12px' }}>
                                <Pill size={24} style={{ color: '#FFa040' }} />
                                1. 기업 개요 및 CMO 시장 지위
                            </h2>
                            ...
                            <p style={{ color: '#c0c0d0', marginBottom: '20px' }}>
                                ...
                                설립 이후 공격적인 생산시설 투자를 통해 <strong style={{ color: '#FFa040' }}>단기간에 글로벌 CMO 1위</strong>로
                                성장했습니다.
                            </p>

                            <div style={{ background: 'linear-gradient(135deg, #4c1d95 0%, #141417 100%)', borderRadius: '12px', padding: '25px', marginBottom: '25px', border: '1px solid #FFa040' }}>
                                <h3 style={{ color: '#FFa040', marginBottom: '15px', fontSize: '1.1rem' }}>CMO란 무엇인가?</h3>
                            ...
                            <div style={{ background: '#141417', borderRadius: '12px', padding: '20px', marginBottom: '25px', border: '1px solid #2a2a30' }}>
                                <h3 style={{ color: '#FFa040', marginBottom: '15px', fontSize: '1.1rem' }}>생산시설 현황 (인천 송도)</h3>
                                <ul style={{ color: '#8888a0', margin: 0, paddingLeft: '20px' }}>
                                    <li style={{ marginBottom: '10px' }}><strong style={{ color: '#f0f0f5' }}>1공장:</strong> 30,000L (2013년 가동)</li>
                                    <li style={{ marginBottom: '10px' }}><strong style={{ color: '#f0f0f5' }}>2공장:</strong> 152,000L (2018년 가동)</li>
                                    <li style={{ marginBottom: '10px' }}><strong style={{ color: '#f0f0f5' }}>3공장:</strong> 180,000L (2020년 가동)</li>
                                    <li style={{ marginBottom: '10px' }}><strong style={{ color: '#f0f0f5' }}>4공장:</strong> 256,000L (2023년 가동)</li>
                                    <li><strong style={{ color: '#00d084' }}>총 생산능력:</strong> 618,000L (글로벌 최대)</li>
                                </ul>
                            </div>
                        ...
                        <section style={{ marginBottom: '45px' }}>
                            ...
                            <div style={{
                                ...
                                <h3 style={{ color: '#FFa040', marginBottom: '20px', fontSize: '1.2rem', textAlign: 'center' }}>
                                    2026년 3분기 주요 실적 (연결 기준)
                                </h3>
                                <div style={{ display: 'grid', gridTemplateColumns: isMobile ? '1fr' : 'repeat(3, 1fr)', gap: '20px' }}>
                                    <div style={{ textAlign: 'center' }}>
                                        <p style={{ color: '#8888a0', fontSize: '0.9rem', marginBottom: '5px' }}>매출액</p>
                                        <p style={{ color: '#f0f0f5', fontSize: '1.5rem', fontWeight: '700', margin: 0 }}>1조 6,602억</p>
                                    </div>
                                    <div style={{ textAlign: 'center' }}>
                                        <p style={{ color: '#8888a0', fontSize: '0.9rem', marginBottom: '5px' }}>영업이익</p>
                                        <p style={{ color: '#00d084', fontSize: '1.5rem', fontWeight: '700', margin: 0 }}>7,288억</p>
                                    </div>
                                    <div style={{ textAlign: 'center' }}>
                                        <p style={{ color: '#8888a0', fontSize: '0.9rem', marginBottom: '5px' }}>영업이익률</p>
                                        <p style={{ color: '#cc6e00', fontSize: '1.5rem', fontWeight: '700', margin: 0 }}>약 43.9%</p>
                                    </div>
                                </div>
                            </div>

                            <h3 style={{ color: '#f0f0f5', fontSize: '1.2rem', marginBottom: '15px' }}>압도적인 수익성</h3>
                            <p style={{ color: '#c0c0d0', marginBottom: '20px' }}>
                                2026년 3분기 삼성바이오로직스는 매출액 <strong style={{ color: '#FF8C00' }}>1조 6,602억원</strong>,
                                영업이익 <strong style={{ color: '#00d084' }}>7,288억원</strong>을 기록했습니다.
                                영업이익률 <strong style={{ color: '#cc6e00' }}>43.9%</strong>는 제조업 중에서도 최상위 수준입니다.
                            </p>
                                ...
                                <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '0.9rem' }}>
                                    ...
                                    <tbody>
                                        <tr style={{ borderBottom: '1px solid #2a2a30' }}>
                                            ...
                                            <td style={{ color: '#f0f0f5', padding: '10px', textAlign: 'right' }}>1.26조</td>
                                            <td style={{ color: '#00d084', padding: '10px', textAlign: 'right' }}>3,257억</td>
                                            <td style={{ color: '#cc6e00', padding: '10px', textAlign: 'right' }}>25.9%</td>
                                        </tr>
                                        <tr style={{ borderBottom: '1px solid #2a2a30' }}>
                                            <td style={{ color: '#f0f0f5', padding: '10px' }}>2025 1Q</td>
                                            <td style={{ color: '#f0f0f5', padding: '10px', textAlign: 'right' }}>1.30조</td>
                                            <td style={{ color: '#00d084', padding: '10px', textAlign: 'right' }}>4,867억</td>
                                            <td style={{ color: '#cc6e00', padding: '10px', textAlign: 'right' }}>37.5%</td>
                                        </tr>
                                        <tr style={{ borderBottom: '1px solid #2a2a30' }}>
                                            <td style={{ color: '#f0f0f5', padding: '10px' }}>2025 2Q</td>
                                            <td style={{ color: '#f0f0f5', padding: '10px', textAlign: 'right' }}>1.29조</td>
                                            <td style={{ color: '#00d084', padding: '10px', textAlign: 'right' }}>4,756억</td>
                                            <td style={{ color: '#cc6e00', padding: '10px', textAlign: 'right' }}>36.9%</td>
                                        </tr>
                                        <tr>
                                            <td style={{ color: '#f0f0f5', padding: '10px', fontWeight: '600' }}>2025 3Q</td>
                                            <td style={{ color: '#f0f0f5', padding: '10px', textAlign: 'right', fontWeight: '600' }}>1.66조</td>
                                            <td style={{ color: '#00d084', padding: '10px', textAlign: 'right', fontWeight: '600' }}>7,288억</td>
                                            <td style={{ color: '#cc6e00', padding: '10px', textAlign: 'right', fontWeight: '600' }}>43.9%</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                            ...
                            <div style={{ background: '#141417', borderRadius: '12px', padding: '20px', marginBottom: '25px', border: '1px solid #2a2a30' }}>
                                <h4 style={{ color: '#d4a853', marginBottom: '12px', fontSize: '1rem' }}>💡 CMO 산업의 수익 구조</h4>
                        ...
                        <section style={{ marginBottom: '45px' }}>
                            ...
                            <div style={{ background: '#141417', borderRadius: '12px', padding: '25px', marginBottom: '25px', border: '1px solid #d4a853' }}>
                                ...
                                <div style={{ marginBottom: '20px' }}>
                                    <h4 style={{ color: '#f0f0f5', fontSize: '1rem', marginBottom: '8px' }}>1. 높은 밸류에이션</h4>
                                    <p style={{ color: '#8888a0', margin: 0, fontSize: '0.95rem' }}>
                                ...
                                <div style={{ marginBottom: '20px' }}>
                                    <h4 style={{ color: '#f0f0f5', fontSize: '1rem', marginBottom: '8px' }}>2. 경쟁 심화</h4>
                                    <p style={{ color: '#8888a0', margin: 0, fontSize: '0.95rem' }}>
                                ...
                                <div style={{ marginBottom: '20px' }}>
                                    <h4 style={{ color: '#f0f0f5', fontSize: '1rem', marginBottom: '8px' }}>3. 고객사 집중도</h4>
                                    <p style={{ color: '#8888a0', margin: 0, fontSize: '0.95rem' }}>
                                ...
                                <div>
                                    <h4 style={{ color: '#f0f0f5', fontSize: '1rem', marginBottom: '8px' }}>4. 환율 리스크</h4>
                                    <p style={{ color: '#8888a0', margin: 0, fontSize: '0.95rem' }}>
                        ...
                        {/* CTA Section */}
                        <section style={{
                            background: 'linear-gradient(135deg, #4c1d95 0%, #FF8C00 100%)',
                            borderRadius: '16px', padding: '30px', marginBottom: '40px',
                            textAlign: 'center', border: '1px solid #FFa040'
                        }}>
                    ...
                    <div style={{ marginTop: '40px', padding: '30px', background: 'rgba(0, 0, 0, 0.6)', borderRadius: '16px', border: '1px solid rgba(255, 255, 255, 0.06)' }}>
                        ...
                        <div style={{ display: 'flex', flexWrap: 'wrap', gap: '12px' }}>
                            <Link to="/stocks/068270" style={{ color: '#FF8C00', background: 'rgba(255, 140, 0, 0.08)', padding: '10px 18px', borderRadius: '8px', textDecoration: 'none', fontSize: '0.9rem' }}>셀트리온 (068270)</Link>
                            <Link to="/stocks/326030" style={{ color: '#FF8C00', background: 'rgba(255, 140, 0, 0.08)', padding: '10px 18px', borderRadius: '8px', textDecoration: 'none', fontSize: '0.9rem' }}>SK바이오팜 (326030)</Link>
                            <Link to="/stocks/005930" style={{ color: '#FF8C00', background: 'rgba(255, 140, 0, 0.08)', padding: '10px 18px', borderRadius: '8px', textDecoration: 'none', fontSize: '0.9rem' }}>삼성전자 (005930)</Link>
                        </div>
                    </div>
